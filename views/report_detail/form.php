    ...
    <!-- general form elements disabled -->
      ...
      <form role="form" action="<?= $action?> " method="post">
          ...
          <div class="box-footer">
            <?php if (strpos($permit, 'u') !== false || strpos($permit, 'c') !== false){ ?>
              <input class="btn btn-info" type="submit" value="Lihat Detail"/>
            <?php } ?>
          <!-- <input class="btn btn-primary" type="button" id="excela" value="Excel Transaksi" onclick="saveexcel('a')"/>
          <input class="btn btn-primary" type="button" id="excela" value="Excel Item" onclick="saveexcel('b')"/> -->
          </div>
          </div><!-- /.box -->
      </form>
    </div><!--/.col (right) -->
