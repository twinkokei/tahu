            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td style="text-align:center;">
                 ...
                 <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['konversi_id']; ?>,'stock_master.php?page=delete_konversi&item_id=<?= $id?>&id=')"
...
function select_satuan(){
  var id = $('#item_id').val()
    $('#medium_modal').modal();
  var url = 'stock_master.php?page=pop_modal_konversi&id='+id;
    $('#medium_modal_content').load(url,function(result){});
}
function edit_konversi(konversi_id){
  var id = $('#item_id').val()
    $('#medium_modal').modal();
  var url = 'stock_master.php?page=pop_modal_konversi&id='+id+'&konversi_id='+konversi_id;
    $('#medium_modal_content').load(url,function(result){});
}
</script>