            ...
            while($row = mysql_fetch_array($query)){ ?>
              <tr>
                ...
                <td style="text-align:center;">
                  <a href="satuan_menu.php?page=form&id=<?= $row['satuan_id']?>" class="btn btn-default" >
                    <i class="fa fa-pencil"></i>
                  </a>
                  <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['satuan_id']; ?>,'satuan_menu.php?page=delete&id=')"
