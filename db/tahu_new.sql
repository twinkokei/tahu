...
MySQL - 5.5.5-10.1.21-MariaDB : Database - tahu
*********************************************************************
*/
...
CREATE TABLE `inventory_stocks` (
  ...
  `inventory_stock_date` datetime NOT NULL,
  `item` int(11) DEFAULT NULL,
  `item_in_qty` int(11) DEFAULT NULL,
  `item_out_qty` int(11) DEFAULT NULL,
  `item_akhir_bulan_qty` int(11) DEFAULT NULL,
