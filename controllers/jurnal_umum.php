...
switch ($page) {
	...
	case 'form':
		...
		if($id){
			...
			$row->bank_id = false;
			$row->bank_id_to = false;
			$row->bank_account = false;
			$row->bank_account_to = false;
			$row->branch_id = false;
	...
	case 'save':
		...
		$i_bank_id_to = get_isset($i_bank_id_to);
		$i_bank_account = get_isset($i_bank_account);
		$i_bank_account_to = get_isset($i_bank_account_to);
	...
	case 'edit':
		...
		$i_branch_id = get_isset($i_branch_id);
					...
					bank_id = '$i_bank_id',
					bank_id_to = '$i_bank_id_to',
					bank_account = '$i_bank_account',
					bank_account_to = '$i_bank_account_to',
